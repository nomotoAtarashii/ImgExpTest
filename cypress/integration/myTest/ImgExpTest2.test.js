...
describe('Sprint 3 Test', () => {
    ...
    var usermail = "thinh8@gmail.com";
    var userpass = 'thinh_Thinh-1234';
    ...
    it.skip('sign_up_06 - Verify that your password can contain only alphanumeric, upper case, lowercase, undercore(_) and dash(-)', () => {
        ...
        cy.get('#signUpEmail').type(usermail)
        userpass = 'thinh_Thinh-1234'
        cy.get('#signUpPassword').type(userpass)
        cy.get('#signUpRepassword').type(userpass, {force:true})
        // Click SIGN UP button to submit
        cy.get('#signUpSubmit').click({force:true})
    ...
    it.skip('sign_in_01 - Verify that input  tags are required', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
        ...
        // CHECK RESULTS
        // Check that error message is being output
        cy.contains('Email is required').should('exist', {setTimeout: 600000})
        cy.contains('Password is required').should('exist', {setTimeout: 600000})
    ...
    it.skip('sign_in_02 - Verify that your email must have domain name after "@"', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip('sign_in_03 - Verify that the site do not accept incorrect account input', () =>{
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip('sign_in_04 - Password must be distinguished from upper and lower case', () =>{
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it(' Change password_01 - Verify that your old password is correct to change the password', () =>{
        ...
        cy.get('body > app-root > app-home > app-header > div > header > a.btn.btn-danger.rounded-pill.sign-in').click()
        cy.get('#sign-in-btn').click();
        cy.get('#signInEmail').type(usermail)
        cy.wait(2000)
        cy.get('#signInPassword').type(userpass)
        cy.wait(2000)
        // Click SIGN UP button to submit
        cy.get('#signInSubmit').click({force:true})
        cy.wait(80000)
        ...
        cy.get('body > app-root > app-change-password > div > div > div > form > div:nth-child(3) > p-password > div > input').type(userpass)
        userpass = '0898313744';
    ...
    it.skip(' Change password_02 - Verify that input tags are required', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip(' Change password_03- Verify that "Confirm Password" needs to be the same as "New Password"', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip(' Change password_04 - Verify that "Confirm Password" and "New Password" contain 50 characters at most', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip(' Change name - Verify that your user name can contain 50 characters at most', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip(' Change name_ 02 - Verify that input  tags are required', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
    ...
    it.skip(' Change name_ 03 -  Verify that name input support all language', () => {
        //STEPS TO DO 
        //Visit the imgexp site
        cy.visit('http://imgexp.herokuapp.com')
        // Click Sign-in button
